...
if (isset($_POST['search_data'])) {
    ...
    if(isset($search_data['gender']) && isset($search_data['seeking']) && isset($search_data['age-range']) && isset($search_data['distance-range']) ){
        ...
        if( count($users) > 0){
            ...
            $query = "SELECT users.user_id, firstname, lastname, age, gender, seeking
            FROM users LEFT JOIN profiles ON profiles.user_id=users.user_id 
            ...
            $query = rtrim($query, ",") . ")&& profiles.banned = 0";
