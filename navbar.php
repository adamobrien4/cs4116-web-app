...
<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-brand"><a href="<?php echo $_ENV['site_home']?>profile"><img style="border-radius: 4px; word-break: break-all;" id="navbar-profile-img" src="../assets/uploads/<?php echo $_SESSION['user_id'] ?>.jpg" width="50px" height="50px" alt="Icon" />&nbsp;<?php echo ($_SESSION['fullname']); ?></a></li>
